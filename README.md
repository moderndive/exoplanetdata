...
(`planets` and `stars`) that load instantly with `data()` and need no
network access — the column names, units, and types have been curated
for classroom use. It is *not* a client for the NASA archive.
